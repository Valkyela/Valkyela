...
I’m Destiny, an Information Security Specialist with a niche in Data Science, Machine Learning, and Artificial Intelligence, focused on leveraging data‑driven and intelligent systems to strengthen security operations.

## 🎓 Education

B.S. Cybersecurity Technologies, University of Maryland Global Campus (UMGC) – Cum Laude
Minor: Management of Information Systems

Undergraduate Certificate Cyber Threat Hunting, University of Maryland Global Campus (UMGC) – Cum Laude

A.A.S. General Studies Degree, Harrisburg Area Community College (HACC) – Dean’s List
...
|  **Cert Name** |  **Certifying Body** |
|---|---|
|  **CompTIA SecAI+ Beta Exam Candidate** | CompTIA  |
